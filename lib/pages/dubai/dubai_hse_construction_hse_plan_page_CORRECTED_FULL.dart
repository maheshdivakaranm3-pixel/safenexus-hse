...
class _OriginalDetailHost extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // The router already supplies the correct ReferenceTopic.
    // Pass that topic directly to the original detailed-topic page.
    // This preserves all existing Construction HSE Plan content.
