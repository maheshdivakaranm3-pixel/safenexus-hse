...
/// content in this file. It adds the Advanced Learning layer ABOVE the
  ...
  Widget _noticeCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: const Color(0xFFE6C76A).withValues(alpha: .55),
        ),
      ),
      child: const Row(
        crossAxisAlignment: CrossAxisAlignment.start,
...
class _OriginalPlanContent extends StatelessWidget {
  // FIX: no optional `key` is declared because this private widget never
  // receives a key. This removes the flutter analyze unused_element_parameter
  // warning that was stopping the GitHub Actions build.
  const _OriginalPlanContent();
  ...
  static const List<_PlanItem> _types = [
    _PlanItem(
      ...
      detail:
          'Project HSE Plan is a key type or application within construction hse plan. Its selection and use should match the task, risk assessment, approved method and applicable equipment or system requirements.',
    ),
    _PlanItem(
      title: 'Construction Phase Plan',
      detail:
          'Construction Phase Plan is a key type or application within construction hse plan. Its selection and use should match the task, risk assessment, approved method and applicable equipment or system requirements.',
    ),
    _PlanItem(
      title: 'Activity Control Plan',
      detail:
          'Activity Control Plan is a key type or application within construction hse plan. Its selection and use should match the task, risk assessment, approved method and applicable equipment or system requirements.',
    ),
    _PlanItem(
      title: 'Emergency Plan',
      detail:
          'Emergency Plan is a key type or application within construction hse plan. Its selection and use should match the task, risk assessment, approved method and applicable equipment or system requirements.',
    ),
  ];
  ...
  static const List<_PlanItem> _items = [
    _PlanItem(
      title: 'HSE Plan',
      detail:
          'HSE Plan is a key component or control item for construction hse plan. Its purpose, condition, suitability and use must be checked against the task, approved system and competent-person requirements.',
    ),
    _PlanItem(
      title: 'Organisation Chart',
      detail:
          'Organisation Chart is a key component or control item for construction hse plan. Its purpose, condition, suitability and use must be checked against the task, approved system and competent-person requirements.',
    ),
    _PlanItem(
      title: 'Risk Register',
      detail:
          'Risk Register is a key component or control item for construction hse plan. Its purpose, condition, suitability and use must be checked against the task, approved system and competent-person requirements.',
    ),
    _PlanItem(
      title: 'Training Plan',
      detail:
          'Training Plan is a key component or control item for construction hse plan. Its purpose, condition, suitability and use must be checked against the task, approved system and competent-person requirements.',
    ),
    _PlanItem(
      title: 'Inspection Programme',
      detail:
          'Inspection Programme is a key component or control item for construction hse plan. Its purpose, condition, suitability and use must be checked against the task, approved system and competent-person requirements.',
    ),
    _PlanItem(
      title: 'Emergency Plan',
      detail:
          'Emergency Plan is a key component or control item for construction hse plan. Its purpose, condition, suitability and use must be checked against the task, approved system and competent-person requirements.',
    ),
  ];
    ...
    _PlanSection(
      ...
      items: [
        _PlanItem(
          title: 'Purpose',
          detail:
              'Define project HSE arrangements and translate requirements into work-package controls.',
        ),
        _PlanItem(
          title: 'Scope',
          detail:
              'Apply construction hse plan across planning, execution, inspection, supervision and close-out.',
        ),
      ],
    ),
    _PlanSection(
      ...
      items: [
        _PlanItem(
          ...
          detail:
              'Approved plan, risk register, method statements, permits and emergency arrangements must align with actual site activities.',
        ),
        _PlanItem(
          title: 'Competence',
          detail:
              'Use personnel with suitable training, experience and authority for construction hse plan.',
        ),
        _PlanItem(
          title: 'Limits',
          detail:
              'Follow approved procedures, equipment/system instructions and project-specific limits for construction hse plan.',
        ),
      ],
    ),
    _PlanSection(
      ...
      items: [
        _PlanItem(
          ...
          detail:
              'Uncontrolled work, unclear responsibilities, missing emergency arrangements and outdated documents.',
        ),
        _PlanItem(
          title: 'Interface hazards',
          detail:
              'Consider people, plant, access, temporary works and simultaneous operations affecting construction hse plan.',
        ),
        _PlanItem(
          title: 'Change',
          detail:
              'Review controls when conditions affecting construction hse plan change.',
        ),
      ],
    ),
    _PlanSection(
      ...
      items: [
        _PlanItem(
          ...
          detail:
              'Verify documents before mobilisation, brief teams, monitor implementation and update when scope or conditions change.',
        ),
        _PlanItem(
          title: 'Supervision',
          detail:
              'Maintain field supervision appropriate to the risk of construction hse plan.',
        ),
        _PlanItem(
          title: 'Communication',
          detail:
              'Brief affected personnel on the controls for construction hse plan before exposure.',
        ),
      ],
    ),
    _PlanSection(
      ...
      items: [
        _PlanItem(
          title: 'Pre-start',
          detail:
              'Inspect the relevant area, equipment and controls before construction hse plan begins.',
        ),
        _PlanItem(
          title: 'Ongoing checks',
          detail:
              'Monitor critical conditions during construction hse plan and after changes.',
        ),
        _PlanItem(
          title: 'Action closure',
          detail:
              'Correct defects and verify effectiveness before restart.',
        ),
      ],
    ),
    _PlanSection(
      ...
      items: [
        _PlanItem(
          ...
          detail:
              'Stop affected work when critical controls or approved arrangements are missing.',
        ),
        _PlanItem(
          title: 'Unsafe condition',
          detail:
              'Stop when construction hse plan cannot be performed within the approved safe system.',
        ),
        _PlanItem(
          title: 'Changed conditions',
          detail:
              'Pause and reassess when the actual construction hse plan activity differs materially from the plan.',
        ),
      ],
    ),
    _PlanSection(
      ...
      items: [
        _PlanItem(
          title: 'Management',
          detail:
              'Provide resources and competent arrangements for construction hse plan.',
        ),
        _PlanItem(
          title: 'Supervisor',
          detail:
              'Control the workface and verify safe execution of construction hse plan.',
        ),
        _PlanItem(
          title: 'HSE',
          detail:
              'Monitor compliance and advise on risk controls for construction hse plan.',
        ),
      ],
    ),
    _PlanSection(
      ...
      items: [
        _PlanItem(
          title: 'Follow method',
          detail:
              'Perform construction hse plan only within approved instructions and competence.',
        ),
        _PlanItem(
          title: 'Report',
          detail:
              'Report hazards, defects and changes affecting construction hse plan.',
        ),
        _PlanItem(
          title: 'Protect others',
          detail:
              'Maintain segregation, housekeeping and safe behaviour.',
        ),
      ],
    ),
    _PlanSection(
      ...
      items: [
        _PlanItem(
          ...
          detail:
              'Stop the task, raise the alarm and protect the area.',
        ),
        _PlanItem(
          title: 'Response',
          detail:
              'Use the project emergency arrangements relevant to construction hse plan.',
        ),
        _PlanItem(
          title: 'Restart',
          detail:
              'Do not resume until the cause and critical controls have been addressed.',
        ),
      ],
    ),
    _PlanSection(
      title: 'Practical Site Example',
      items: [
        _PlanItem(
          title: 'Construction HSE Plan',
          detail:
              'A control gap is identified during construction hse plan. The task is paused, the area is made safe, the responsible person corrects the condition and the work is rechecked before restart.',
        ),
        _PlanItem(
          title: 'Verification',
          detail:
              'HSE verifies the corrective action and records the learning related to construction hse plan.',
        ),
      ],
    ),
    _PlanSection(
      ...
      items: [
        _PlanItem(
          title: 'PLAN → CONTROL → INSPECT → ACT',
          detail:
              'Safe execution depends on active control throughout the task.',
        ),
        _PlanItem(
          title: 'Verify in the field',
          detail:
              'Documentation must match the real conditions of construction hse plan.',
        ),
        _PlanItem(
          title: 'Stop early',
          detail:
              'Early intervention prevents a control failure becoming an incident.',
        ),
      ],
    ),
    _PlanSection(
      ...
      items: [
        _PlanItem(
          title: 'Management',
          detail:
              'Approve resources, responsibilities and HSE objectives.',
        ),
        _PlanItem(
          title: 'HSE team',
          detail:
        ...
        _PlanItem(
          title: 'Supervisors',
          detail:
              'Apply the plan at workface level.',
        ),
      ],
    ),
  ];
    ...
    required IconData icon,
      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: const Color(0xFF159447).withValues(alpha: .14),
          ),
        ),
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
