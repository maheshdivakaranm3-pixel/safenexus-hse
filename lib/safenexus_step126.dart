...
class SafeNexusStep126Page extends StatefulWidget {
  const SafeNexusStep126Page({super.key});

  @override
  State<SafeNexusStep126Page> createState() => _SafeNexusStep126PageState();
}

class _SafeNexusStep126PageState extends State<SafeNexusStep126Page> {
  ...
  Future<void> _addRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-126-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 126,
      'module': 'HSE Actions & Closure',
      'source': 'SafeNexus HSE Step 126',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Step 126 — HSE Actions & Closure'),
