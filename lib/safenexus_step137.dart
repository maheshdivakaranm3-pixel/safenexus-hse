...
/// SafeNexus HSE — Step 137
/// HSE Action Due-Date Control
///
...
/// Existing fields are preserved and Step 137 fields are additive.

class SafeNexusStep137Page extends StatefulWidget {
  const SafeNexusStep137Page({super.key});

  @override
  State<SafeNexusStep137Page> createState() =>
      _SafeNexusStep137PageState();
}

class _SafeNexusStep137PageState
    extends State<SafeNexusStep137Page> {
  ...
  Future<void> _addControlRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-137-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 137,
      'module': 'HSE Action Due-Date Control',
      'source': 'SafeNexus HSE Step 137',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Step 137 — HSE Action Due-Date Control',
        ),
