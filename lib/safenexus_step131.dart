...
/// SafeNexus HSE — Step 131
/// HSE Closure Verification
///
...
class SafeNexusStep131Page extends StatefulWidget {
  const SafeNexusStep131Page({super.key});

  @override
  State<SafeNexusStep131Page> createState() => _SafeNexusStep131PageState();
}

class _SafeNexusStep131PageState extends State<SafeNexusStep131Page> {
  ...
  Future<void> _addRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-131-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 131,
      'module': 'HSE Closure Verification',
      'source': 'SafeNexus HSE Step 131',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Step 131 — HSE Closure Verification'),
