...
class SafeNexusStep149Page extends StatefulWidget {{
  const SafeNexusStep149Page({{super.key}});

  @override
  State<SafeNexusStep149Page> createState() => _SafeNexusStep149PageState();
}}

class _SafeNexusStep149PageState extends State<SafeNexusStep149Page> {{
  static const String _storageKey = 'workhub_hse_actions_v1';
  static const String _stepPurpose = 'Track action completion and performance indicators.';
  ...
  Future<void> _addRecord() async {{
    ...
    _records.insert(0, {{
      'id': 'SN-149-${{DateTime.now().millisecondsSinceEpoch}}',
  ...
  Widget build(BuildContext context) {{
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Step 149 — HSE Action Performance'),
        actions: [
          IconButton(
            tooltip: 'Refresh',
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Add a follow-up record for HSE Action Performance.',
              textAlign: TextAlign.center,
            ),
          ],
        ),
