...
/// SafeNexus HSE — Step 132
/// HSE Action Dashboard
///
...
class SafeNexusStep132Page extends StatefulWidget {
  const SafeNexusStep132Page({super.key});

  @override
  State<SafeNexusStep132Page> createState() => _SafeNexusStep132PageState();
}

class _SafeNexusStep132PageState extends State<SafeNexusStep132Page> {
  ...
  Future<void> _addRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-132-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 132,
      'module': 'HSE Action Dashboard',
      'source': 'SafeNexus HSE Step 132',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Step 132 — HSE Action Dashboard'),
