...
/// SafeNexus HSE — Step 133
/// HSE Action Escalation
///
...
class SafeNexusStep133Page extends StatefulWidget {
  const SafeNexusStep133Page({super.key});

  @override
  State<SafeNexusStep133Page> createState() => _SafeNexusStep133PageState();
}

class _SafeNexusStep133PageState extends State<SafeNexusStep133Page> {
  ...
  Future<void> _addRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-133-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Step 133 — HSE Action Escalation'),
