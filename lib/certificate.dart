...
class _CertificatePageState extends State<CertificatePage> {
                      ...
                      pw.Container(
                        ...
                        child: pw.Text(
                          ...
                          style: pw.TextStyle(
                            color: pdfPrimaryColor,
                            fontSize:
                                nameFontSize > 40 ? 40 : nameFontSize,
                            fontWeight: pw.FontWeight.bold,
                          ),
                        ),
                      ),
  ...
  Widget _certificatePreview() {
    ...
    final String previewSignatory =
        _cleanText(
      _signatoryController.text,
      fallback: 'Authorized Signatory',
    );

    final String previewFooter =
        _cleanText(
      _footerController.text,
      fallback: 'Identify. Report. Stay Safe.',
    );
...
class _ConstructionBackgroundPainter
  ...
  @override
  bool shouldRepaint(
    covariant _ConstructionBackgroundPainter
        oldDelegate,
  ) {
