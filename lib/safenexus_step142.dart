...
/// SafeNexus HSE — Step 142
/// HSE Action Escalation Control
///
...
/// Existing fields are preserved and Step 142 fields are additive.

class SafeNexusStep142Page extends StatefulWidget {
  const SafeNexusStep142Page({super.key});

  @override
  State<SafeNexusStep142Page> createState() =>
      _SafeNexusStep142PageState();
}

class _SafeNexusStep142PageState
    extends State<SafeNexusStep142Page> {
  ...
  Future<void> _addControlRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-142-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 142,
      'module': 'HSE Action Escalation Control',
      'source': 'SafeNexus HSE Step 142',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Step 142 — HSE Action Escalation Control',
        ),
