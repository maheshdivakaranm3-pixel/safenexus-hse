...
class SafeNexusStep154Page extends StatefulWidget {
  ...
  @override
  State<SafeNexusStep154Page> createState() => _SafeNexusStep154ageState();
}

class _SafeNexusStep154ageState extends State<SafeNexusStep154Page> {
  ...
  Future<void> _addRecord() async {
    ...
    _records.insert(0, <String, dynamic>{
      'id': 'SN-154-${DateTime.now().millisecondsSinceEpoch}',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Step 154 — HSE PTW Follow-up'),
        actions: <Widget>[
          IconButton(
