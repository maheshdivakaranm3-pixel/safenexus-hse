...
class SafeNexusStep154Page extends StatefulWidget {
  const SafeNexusStep154Page({super.key});

  @override
  State<SafeNexusStep154Page> createState() =>
      _SafeNexusStep154PageState();
}

class _SafeNexusStep154PageState
    extends State<SafeNexusStep154Page> {
  ...
  Future<void> _addRecord() async {
    ...
    _records.insert(
      ...
      <String, dynamic>{
        'id':
            'SN-154-${DateTime.now().millisecondsSinceEpoch}',
