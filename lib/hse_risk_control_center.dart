...
class HseRiskControlCenterPage extends StatefulWidget {
  const HseRiskControlCenterPage({
    super.key,
    this.sourceOpener,
  });
  ...
  @override
  State<HseRiskControlCenterPage> createState() =>
      _HseRiskControlCenterPageState();
}

class _HseRiskControlCenterPageState
    extends State<HseRiskControlCenterPage> {
