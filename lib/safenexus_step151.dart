...
class SafeNexusStep151Page extends StatefulWidget {{
  const SafeNexusStep151Page({{super.key}});

  @override
  State<SafeNexusStep151Page> createState() => _SafeNexusStep151PageState();
}}

class _SafeNexusStep151PageState extends State<SafeNexusStep151Page> {{
  static const String _storageKey = 'workhub_hse_actions_v1';
  static const String _stepPurpose = 'Track inspection findings through completion.';
  ...
  Future<void> _addRecord() async {{
    ...
    _records.insert(0, {{
      'id': 'SN-151-${{DateTime.now().millisecondsSinceEpoch}}',
      ...
      'updatedAt': now,
      'step': 151,
      'module': 'HSE Inspection Follow-up',
  ...
  Widget build(BuildContext context) {{
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Step 151 — HSE Inspection Follow-up'),
        actions: [
          IconButton(
            tooltip: 'Refresh',
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Add a follow-up record for HSE Inspection Follow-up.',
              textAlign: TextAlign.center,
            ),
          ],
        ),
