...
//
// Corrected version:
// - Shared colors are file-level constants.
// - All helper widgets can safely access the same color palette.
// - Compatible with modern Flutter Color.withValues() API.
// ============================================================================
...
icon: Icons.menu_book_outlined,
      ...
      ...List.generate(
        references.length,
        (index) {
          final reference = references[index].trim();
