...
class SafeNexusStep152Page extends StatefulWidget {{
  const SafeNexusStep152Page({{super.key}});

  @override
  State<SafeNexusStep152Page> createState() => _SafeNexusStep152PageState();
}}

class _SafeNexusStep152PageState extends State<SafeNexusStep152Page> {{
  static const String _storageKey = 'workhub_hse_actions_v1';
  static const String _stepPurpose = 'Track safety observations and corrective follow-up.';
  ...
  Future<void> _addRecord() async {{
    ...
    _records.insert(0, {{
      'id': 'SN-152-${{DateTime.now().millisecondsSinceEpoch}}',
      ...
      'updatedAt': now,
      'step': 152,
      'module': 'HSE Observation Follow-up',
  ...
  Widget build(BuildContext context) {{
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Step 152 — HSE Observation Follow-up'),
        actions: [
          IconButton(
            tooltip: 'Refresh',
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Add a follow-up record for HSE Observation Follow-up.',
              textAlign: TextAlign.center,
            ),
          ],
        ),
