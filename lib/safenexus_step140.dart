...
/// SafeNexus HSE — Step 140
/// HSE Preventive Action Register
///
...
/// Existing fields are preserved and Step 140 fields are additive.

class SafeNexusStep140Page extends StatefulWidget {
  const SafeNexusStep140Page({super.key});

  @override
  State<SafeNexusStep140Page> createState() =>
      _SafeNexusStep140PageState();
}

class _SafeNexusStep140PageState
    extends State<SafeNexusStep140Page> {
  ...
  Future<void> _addControlRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-140-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 140,
      'module': 'HSE Preventive Action Register',
      'source': 'SafeNexus HSE Step 140',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Step 140 — HSE Preventive Action Register',
        ),
