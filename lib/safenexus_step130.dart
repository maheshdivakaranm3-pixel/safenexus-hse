...
class SafeNexusStep130Page extends StatefulWidget {
  const SafeNexusStep130Page({super.key});

  @override
  State<SafeNexusStep130Page> createState() => _SafeNexusStep130PageState();
}

class _SafeNexusStep130PageState extends State<SafeNexusStep130Page> {
  ...
  Future<void> _addRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-130-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 130,
      'module': 'HSE Action Follow-up',
      'source': 'SafeNexus HSE Step 130',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Step 130 — HSE Action Follow-up'),
