...
/// SafeNexus HSE — Step 145
/// HSE Actions Management Control Center
///
...
/// Existing fields are preserved and Step 145 fields are additive.

class SafeNexusStep145Page extends StatefulWidget {
  const SafeNexusStep145Page({super.key});

  @override
  State<SafeNexusStep145Page> createState() =>
      _SafeNexusStep145PageState();
}

class _SafeNexusStep145PageState
    extends State<SafeNexusStep145Page> {
  ...
  Future<void> _addControlRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-145-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 145,
      'module': 'HSE Actions Management Control Center',
      'source': 'SafeNexus HSE Step 145',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Step 145 — HSE Actions Management Control Center',
        ),
