...
class HseAnalyticsCenterPage extends StatefulWidget {
  final List<SafeNexusAnalyticsSource> sources;

  const HseAnalyticsCenterPage({
    super.key,
    this.sources = const <SafeNexusAnalyticsSource>[],
  });

  @override
  State<HseAnalyticsCenterPage> createState() =>
      _HseAnalyticsCenterPageState();
}

class _HseAnalyticsCenterPageState
    extends State<HseAnalyticsCenterPage> {
