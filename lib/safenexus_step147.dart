...
class SafeNexusStep147Page extends StatefulWidget {{
  const SafeNexusStep147Page({{super.key}});

  @override
  State<SafeNexusStep147Page> createState() => _SafeNexusStep147PageState();
}}

class _SafeNexusStep147PageState extends State<SafeNexusStep147Page> {{
  static const String _storageKey = 'workhub_hse_actions_v1';
  static const String _stepPurpose = 'Verify corrective actions before closure.';
  ...
  Future<void> _addRecord() async {{
    ...
    _records.insert(0, {{
      'id': 'SN-147-${{DateTime.now().millisecondsSinceEpoch}}',
      ...
      'updatedAt': now,
      'step': 147,
      'module': 'HSE Action Verification',
  ...
  Widget build(BuildContext context) {{
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Step 147 — HSE Action Verification'),
        actions: [
          IconButton(
            tooltip: 'Refresh',
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Add a follow-up record for HSE Action Verification.',
              textAlign: TextAlign.center,
            ),
          ],
        ),
