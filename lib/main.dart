        ...
        children: [
          ...
          _notificationInfoCard(
            ...
            title:
                'Safety First',
            message:
                'Stay alert, identify hazards and take action for a safer workplace.',
          ),
          const SizedBox(height: 10),
          _notificationInfoCard(
            icon:
            ...
            title:
                'HSE Guidance',
            message:
                'Use the UAE HSE reference library to improve your safety knowledge.',
          ),
        ],
      ),
    );
