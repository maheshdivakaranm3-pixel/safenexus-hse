...
/// SafeNexus HSE — Step 127
/// HSE Action Assignment
///
...
class SafeNexusStep127Page extends StatefulWidget {
  const SafeNexusStep127Page({super.key});

  @override
  State<SafeNexusStep127Page> createState() => _SafeNexusStep127PageState();
}

class _SafeNexusStep127PageState extends State<SafeNexusStep127Page> {
  ...
  Future<void> _addRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-127-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 127,
      'module': 'HSE Action Assignment',
      'source': 'SafeNexus HSE Step 127',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Step 127 — HSE Action Assignment'),
