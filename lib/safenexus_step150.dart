...
class SafeNexusStep150Page extends StatefulWidget {{
  const SafeNexusStep150Page({{super.key}});

  @override
  State<SafeNexusStep150Page> createState() => _SafeNexusStep150PageState();
}}

class _SafeNexusStep150PageState extends State<SafeNexusStep150Page> {{
  static const String _storageKey = 'workhub_hse_actions_v1';
  static const String _stepPurpose = 'Review HSE compliance observations and follow-up requirements.';
  ...
  Future<void> _addRecord() async {{
    ...
    _records.insert(0, {{
      'id': 'SN-150-${{DateTime.now().millisecondsSinceEpoch}}',
  ...
  Widget build(BuildContext context) {{
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Step 150 — HSE Compliance Review'),
        actions: [
          IconButton(
            tooltip: 'Refresh',
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Add a follow-up record for HSE Compliance Review.',
              textAlign: TextAlign.center,
            ),
          ],
        ),
