...
/// SafeNexus HSE — Step 144
/// HSE Action Audit Review
///
...
/// Existing fields are preserved and Step 144 fields are additive.

class SafeNexusStep144Page extends StatefulWidget {
  const SafeNexusStep144Page({super.key});

  @override
  State<SafeNexusStep144Page> createState() =>
      _SafeNexusStep144PageState();
}

class _SafeNexusStep144PageState
    extends State<SafeNexusStep144Page> {
  ...
  Future<void> _addControlRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-144-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 144,
      'module': 'HSE Action Audit Review',
      'source': 'SafeNexus HSE Step 144',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Step 144 — HSE Action Audit Review',
        ),
