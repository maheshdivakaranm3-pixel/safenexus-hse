...
class HseDocumentEvidenceCenterPage
    extends StatefulWidget {
  final SafeNexusDocumentOpener? opener;

  const HseDocumentEvidenceCenterPage({
    super.key,
    this.opener,
  });

  @override
  State<HseDocumentEvidenceCenterPage> createState() =>
      _HseDocumentEvidenceCenterPageState();
}

class _HseDocumentEvidenceCenterPageState
    extends State<HseDocumentEvidenceCenterPage> {
...
Widget safeNexusStep25DocumentEvidenceCenter({
  ...
  return HseDocumentEvidenceCenterPage(
    opener: opener,
  );
}
