...
class SafeNexusStep146Page extends StatefulWidget {{
  const SafeNexusStep146Page({{super.key}});

  @override
  State<SafeNexusStep146Page> createState() => _SafeNexusStep146PageState();
}}

class _SafeNexusStep146PageState extends State<SafeNexusStep146Page> {{
  static const String _storageKey = 'workhub_hse_actions_v1';
  static const String _stepPurpose = 'Review open HSE actions, ownership, priority and progress.';
  ...
  Future<void> _addRecord() async {{
    ...
    _records.insert(0, {{
      'id': 'SN-146-${{DateTime.now().millisecondsSinceEpoch}}',
  ...
  Widget build(BuildContext context) {{
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Step 146 — HSE Action Review'),
        actions: [
          IconButton(
            tooltip: 'Refresh',
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Add a follow-up record for HSE Action Review.',
              textAlign: TextAlign.center,
            ),
          ],
        ),
