...
/// SafeNexus HSE — Step 141
/// HSE Action Evidence Control
///
...
/// Existing fields are preserved and Step 141 fields are additive.

class SafeNexusStep141Page extends StatefulWidget {
  const SafeNexusStep141Page({super.key});

  @override
  State<SafeNexusStep141Page> createState() =>
      _SafeNexusStep141PageState();
}

class _SafeNexusStep141PageState
    extends State<SafeNexusStep141Page> {
  ...
  Future<void> _addControlRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-141-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 141,
      'module': 'HSE Action Evidence Control',
      'source': 'SafeNexus HSE Step 141',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Step 141 — HSE Action Evidence Control',
        ),
