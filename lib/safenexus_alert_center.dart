...
class SafeNexusAlertCenterPage extends StatefulWidget {
  final SafeNexusAlertOpener? opener;

  const SafeNexusAlertCenterPage({
    super.key,
    this.opener,
  });

  @override
  State<SafeNexusAlertCenterPage> createState() =>
      _SafeNexusAlertCenterPageState();
}

class _SafeNexusAlertCenterPageState
    extends State<SafeNexusAlertCenterPage> {
...
Widget safeNexusStep23AlertCenter({
  ...
  return SafeNexusAlertCenterPage(
    opener: opener,
  );
}
