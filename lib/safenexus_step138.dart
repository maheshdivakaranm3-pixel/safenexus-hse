...
/// SafeNexus HSE — Step 138
/// HSE Action Follow-up Register
///
...
/// Existing fields are preserved and Step 138 fields are additive.

class SafeNexusStep138Page extends StatefulWidget {
  const SafeNexusStep138Page({super.key});

  @override
  State<SafeNexusStep138Page> createState() =>
      _SafeNexusStep138PageState();
}

class _SafeNexusStep138PageState
    extends State<SafeNexusStep138Page> {
  ...
  Future<void> _addControlRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-138-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 138,
      'module': 'HSE Action Follow-up Register',
      'source': 'SafeNexus HSE Step 138',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Step 138 — HSE Action Follow-up Register',
        ),
