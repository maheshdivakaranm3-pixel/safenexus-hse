...
/// SafeNexus HSE — Step 143
/// HSE Action Closure Quality
///
...
/// Existing fields are preserved and Step 143 fields are additive.

class SafeNexusStep143Page extends StatefulWidget {
  const SafeNexusStep143Page({super.key});

  @override
  State<SafeNexusStep143Page> createState() =>
      _SafeNexusStep143PageState();
}

class _SafeNexusStep143PageState
    extends State<SafeNexusStep143Page> {
  ...
  Future<void> _addControlRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-143-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
      ...
      'updatedAt': now,
      'step': 143,
      'module': 'HSE Action Closure Quality',
      'source': 'SafeNexus HSE Step 143',
    };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Step 143 — HSE Action Closure Quality',
        ),
