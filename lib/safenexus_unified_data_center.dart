...
class SafeNexusUnifiedDataCenterPage extends StatefulWidget {
  final List<SafeNexusRecordSource> sources;

  const SafeNexusUnifiedDataCenterPage({
    super.key,
    this.sources = const <SafeNexusRecordSource>[],
  });

  @override
  State<SafeNexusUnifiedDataCenterPage> createState() =>
      _SafeNexusUnifiedDataCenterPageState();
}

class _SafeNexusUnifiedDataCenterPageState
    extends State<SafeNexusUnifiedDataCenterPage> {
...
Widget safeNexusStep22DataCenter({
  ...
  return SafeNexusUnifiedDataCenterPage(
    sources: sources,
  );
}
