...
class AbuDhabiCop01To03 {
  ...
  static const asbestos = AbuDhabiCopDocument(
    ...
    sections: [
      ...
      AbuDhabiCopSection(
        ...
        documents: ['Clearance certificate where applicable', 'Waste documentation', 'Updated asbestos register', 'Completed-work report'],
      AbuDhabiCopSection(
        number: 'Inspection and Change Control',
        title: 'Inspection, Reassessment and Release',
        requirements: [
          'Review the ACM condition and control arrangements whenever the building, plant, work activity, access arrangements or ACM condition changes.',
          'Reassess the work area before intrusive maintenance, refurbishment, demolition or other activity that could disturb ACM.',
          'Verify that required controlled-area arrangements, specialist controls, containment, decontamination and waste controls are in place before work proceeds.',
          'After asbestos work, verify that the required clearance and handover arrangements are complete before the area is returned to normal use.',
        ],
        inspection: [
          'Check the current asbestos register and survey information before work starts.',
          'Verify controlled-area boundaries, warning information and access restrictions.',
          'Verify work controls and specialist arrangements remain effective during the task.',
          'Record changes, unexpected findings, completed work and required updates to the asbestos register.',
        ],
        documents: [
          'Current asbestos survey',
          'Asbestos register',
          'Risk assessment / plan of work',
          'Inspection and monitoring records',
          'Clearance / handover records where applicable',
        ],
      ),
      ),
    ],
  ...
  static const ppe = AbuDhabiCopDocument(
    ...
    sections: [
      ...
      AbuDhabiCopSection(
        number: 'Hazard-to-PPE Guide',
        title: 'Common Hazards Requiring PPE Consideration',
        hazards: [
          'Falling or flying objects and impact',
          'Dusts, fumes, vapours, gases and other airborne contaminants',
          'Chemical splash or skin contact',
          'Noise exposure',
          'Heat, flame, sparks or hot surfaces',
          'Electrical contact or arc hazards where applicable',
          'Cuts, punctures, abrasion and sharp edges',
          'Contamination and biological exposure where applicable',
          'Falls from height where a personal fall-protection system is required',
          'Poor visibility / traffic interface where high-visibility clothing is required',
        ],
        requirements: [
          'PPE selection shall follow the actual task and hazard assessment and shall not be treated as a substitute for higher-level controls where those controls are reasonably practicable.',
          'Select PPE with the correct protection level, size, fit, compatibility and limitations for the hazard.',
          'Where several PPE items are required together, confirm that one item does not reduce the protection provided by another.',
          'Replace PPE when damaged, contaminated, expired, excessively worn or otherwise unable to provide the required protection.',
        ],
        inspection: [
          'Check condition, fit, cleanliness, damage, service/expiry status and compatibility before use.',
        ],
      ),
      AbuDhabiCopSection(
  ...
  static const occupationalNoise = AbuDhabiCopDocument(
    ...
    sections: [
      ...
      AbuDhabiCopSection(
        number: 'Exposure Response',
        title: 'What to Do When Noise Exposure Changes',
        requirements: [
          'Reassess noise exposure when equipment, process, production rate, work location, maintenance condition or working hours change in a way that could alter exposure.',
          'Investigate unexpected high measurements and identify the source before relying only on additional hearing protection.',
          'Review engineering and administrative controls first, then confirm that hearing protection remains suitable for the residual exposure.',
          'Communicate changes in noise hazards and required controls to affected workers and contractors.',
        ],
        inspection: [
          'Verify noise controls remain in place and effective.',
          'Check that designated hearing-protection areas are identified and that required protection is available and correctly used.',
          'Review monitoring results and corrective actions when exposure conditions change.',
        ],
        documents: [
          'Updated noise assessment',
          'Measurement / dosimetry results',
          'Corrective-action records',
          'Worker communication / training records',
        ],
      ),
  ...
  static const vibration = AbuDhabiCopDocument(
    ...
    sections: [
      ...
      AbuDhabiCopSection(
        number: '3.9',
        title: 'Equipment Selection and Field Inspection',
        requirements: [
          'Consider vibration magnitude, task duration, frequency of use, tool or vehicle condition and available lower-vibration alternatives before selecting equipment.',
          'Follow manufacturer instructions and maintain tools, vehicles, seats, suspension and other vibration-control components in effective condition.',
          'Where exposure is close to or above an action value, review whether equipment, work method, maintenance or exposure duration can be changed to reduce exposure.',
          'Reassess exposure when equipment, accessories, process, route, work method or operating conditions change.',
        ],
        inspection: [
          'Check equipment condition and vibration-control features before use.',
          'Verify that maintenance defects likely to increase vibration are corrected.',
          'Confirm exposure calculations reflect the actual equipment, task and duration being performed.',
        ],
        documents: [
          'Equipment selection records',
          'Maintenance records',
          'Exposure assessment / calculation',
          'Corrective-action records',
        ],
      ),
