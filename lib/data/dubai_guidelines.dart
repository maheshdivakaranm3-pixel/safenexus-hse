...
const List<ReferenceTopic> dubaiGuidelines = [
  ReferenceTopic(
    ...
    description: 'Comprehensive Dubai HSE legal and regulatory compliance reference covering legal register, compliance matrix, permits, approvals, inspections, audits, corrective actions, contractor compliance, evidence and regulatory change management.',
    keyRequirements: [
      'Identify applicable UAE, Dubai, authority and project HSE requirements.',
      'Maintain a controlled legal and regulatory register.',
      'Maintain a compliance matrix linking obligations to controls and evidence.',
      'Verify permits, NOCs, approvals, certificates and inspections before affected work.',
      'Translate requirements into HSE plans, risk assessments, RAMS and permits.',
      'Monitor contractor and subcontractor compliance.',
      'Maintain current objective evidence and expiry tracking.',
      'Audit compliance and verify corrective actions.',
      'Monitor regulatory changes and update affected controls.',
      'Escalate significant or unresolved non-compliance and control affected work where required.',
    ],
    safetyControls: [
      'Legal register', 'Compliance matrix', 'Permit and approval register',
      'Authority/NOC tracker', 'Certificate register', 'Document control',
      'Regulatory change review', 'Inspection and audit programme',
      'Corrective action tracking', 'Contractor compliance verification',
    ],
    responsibilities: [
      'Project management', 'HSE management', 'Construction management',
      'HSE engineers and supervisors', 'Engineering', 'Procurement',
      'Document control', 'Contractors and subcontractors', 'Workers',
    ],
    references: [
      ...
      'Applicable Dubai Municipality HSE technical guidelines and requirements',
      'Applicable Dubai authority permits, approvals and NOCs',
      'Applicable UAE federal requirements',
      'Project contract, specifications and approved HSE requirements',
    ],
  ),
