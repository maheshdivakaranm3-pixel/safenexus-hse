    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            _AbuDhabiHeroCard(topic: topic),
            const SizedBox(height: 14),
            _AbuDhabiInfoCard(topic: topic),
            const SizedBox(height: 14),
            _AbuDhabiLearningNotice(),
            const SizedBox(height: 14),
            const _AbuDhabiAdvancedBadge(),
...
class _AbuDhabiHeroCard extends StatelessWidget {
  final ReferenceTopic topic;

  const _AbuDhabiHeroCard({required this.topic});
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFF0B5D3B), Color(0xFF159447)],
      ...
      child: Column(
        ...
        children: [
          const Text(
            'ABU DHABI HSE • COMPLETE LEARNING',
            style: TextStyle(
          ...
          const SizedBox(height: 8),
          Text(
            'Tap each section, then tap each item to study the detailed field guidance.',
            style: TextStyle(
...
class _AbuDhabiInfoCard extends StatelessWidget {
  final ReferenceTopic topic;

  const _AbuDhabiInfoCard({required this.topic});
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            _row(Icons.account_balance_outlined, 'Authority', topic.authority),
            const SizedBox(height: 12),
            _row(Icons.location_on_outlined, 'Jurisdiction', topic.jurisdiction),
            const SizedBox(height: 12),
            _row(Icons.category_outlined, 'Topic', topic.category),
          ],
        ),
      ),
    );
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: Icon(icon, color: const Color(0xFF0B5D3B), size: 20),
        ),
...
class _AbuDhabiLearningNotice extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Professional reference content. Use the topic as a learning and field-planning aid, then verify the current official Abu Dhabi requirement, approved project procedure and authority condition before implementation.',
              style: TextStyle(
                fontSize: 13,
                height: 1.5,
...
class _AbuDhabiAdvancedBadge extends StatelessWidget {
  const _AbuDhabiAdvancedBadge();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(
        children: [
          Icon(Icons.school_outlined, color: Colors.white, size: 21),
          SizedBox(width: 9),
          Expanded(
            child: Text(
              'ADVANCED LEARNING • Tap to expand every topic section',
              style: TextStyle(
                color: Colors.white,
                fontWeight: FontWeight.w800,
                fontSize: 13,
