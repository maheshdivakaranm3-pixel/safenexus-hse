...
TbtTopic _makeTbt(int id, String title, String category) {
  return TbtTopic(
    id: id,
    title: title,
    category: category,
    objective: 'Build worker awareness and consistent safe work practices for $title. Apply the approved site risk assessment, RAMS/JSA, permits and local procedures.',
    keyHazards: [
    ...
    ppe: [
      ...
      'Hearing/respiratory/fall protection as identified by the risk assessment',
    ],
    beforeStarting: [
    ...
    workerConfirmation: 'I understand the hazards, controls, PPE and emergency arrangements for this toolbox talk. I will follow the approved safe work procedure and report unsafe conditions immediately.',
  );
}

/// 100 ready-to-use TBT topics. This list is intentionally non-const because
/// topics are created through the helper above.
final List<TbtTopic> tbtTopics = [
  ...
  _makeTbt(89, 'Cleaning and Maintenance Chemicals', 'Chemical Safety'),
  ...
  _makeTbt(95, 'Safety Leadership for Supervisors', 'Safety Leadership'),
  _makeTbt(96, 'Worker Right to Stop Unsafe Work', 'Safety Leadership'),
  _makeTbt(97, 'Safety Rules and Site Discipline', 'Safety Leadership'),
  _makeTbt(98, 'HSE Awareness for New Workers', 'Safety Leadership'),
  _makeTbt(99, 'Safety Culture and Teamwork', 'Safety Leadership'),
  _makeTbt(100, '100% Safe Work Commitment', 'Safety Leadership'),
];
