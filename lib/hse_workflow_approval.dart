...
class HseWorkflowApprovalPage extends StatefulWidget {
  const HseWorkflowApprovalPage({
    super.key,
  ...
  @override
  State<HseWorkflowApprovalPage> createState() => _HseWorkflowApprovalPageState();
}

class _HseWorkflowApprovalPageState extends State<HseWorkflowApprovalPage> {
...
class _WorkflowFormSheet extends StatefulWidget {
  const _WorkflowFormSheet({
  ...
  @override
  State<_WorkflowFormSheet> createState() => _WorkflowFormSheetState();
}

class _WorkflowFormSheetState extends State<_WorkflowFormSheet> {
  static const Color primaryGreen = Color(0xFF159447);
  static const Color darkGreen = Color(0xFF0B5D4B);
