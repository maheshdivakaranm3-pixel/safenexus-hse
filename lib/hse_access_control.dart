...
class HseAccessControlPage extends StatefulWidget {
  const HseAccessControlPage({
    super.key,
  ...
  @override
  State<HseAccessControlPage> createState() => _HseAccessControlPageState();
}

class _HseAccessControlPageState extends State<HseAccessControlPage> {
...
class _AccessFormSheet extends StatefulWidget {
  const _AccessFormSheet({
  ...
  @override
  State<_AccessFormSheet> createState() => _AccessFormSheetState();
}

class _AccessFormSheetState extends State<_AccessFormSheet> {
  static const Color primaryGreen = Color(0xFF159447);
  static const Color darkGreen = Color(0xFF0B5D4B);
