...
class HseBackupRecoveryPage extends StatefulWidget {
  const HseBackupRecoveryPage({super.key});

  @override
  State<HseBackupRecoveryPage> createState() => _HseBackupRecoveryPageState();
}

class _HseBackupRecoveryPageState extends State<HseBackupRecoveryPage> {
...
class _BackupFormSheet extends StatefulWidget {
  const _BackupFormSheet({
  ...
  @override
  State<_BackupFormSheet> createState() => _BackupFormSheetState();
}

class _BackupFormSheetState extends State<_BackupFormSheet> {
  static const Color primaryGreen = Color(0xFF159447);
  static const Color darkGreen = Color(0xFF0B5D4B);
