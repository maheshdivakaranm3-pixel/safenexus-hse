...
class HseContractorSupplierPage extends StatefulWidget {
  const HseContractorSupplierPage({super.key});

  @override
  State<HseContractorSupplierPage> createState() =>
      _HseContractorSupplierPageState();
}

class _HseContractorSupplierPageState
    extends State<HseContractorSupplierPage> {
