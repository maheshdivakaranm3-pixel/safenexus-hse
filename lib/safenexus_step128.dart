...
class SafeNexusStep128Page extends StatefulWidget {
  const SafeNexusStep128Page({super.key});

  @override
  State<SafeNexusStep128Page> createState() => _SafeNexusStep128PageState();
}

class _SafeNexusStep128PageState extends State<SafeNexusStep128Page> {
  ...
  Future<void> _addRecord() async {
    ...
    final record = <String, dynamic>{
      'id': 'ACT-128-${DateTime.now().millisecondsSinceEpoch}',
      'title': result['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Step 128 — Corrective & Preventive Actions'),
