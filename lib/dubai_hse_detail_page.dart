...
final Map<String, _TopicData> _topicData = {
  'dubai_legal_regulatory_compliance': _TopicData(
    title: 'Legal & Regulatory Compliance',
    intro: 'A practical Dubai construction HSE compliance reference for identifying applicable legal requirements, authority conditions, permits, approvals, compliance obligations, evidence, inspections, audits and corrective actions. The project team should always verify the current official requirement and project-specific approval conditions before relying on them.',
    types: [
      _DetailItem(title: 'Legal Register', detail: 'A controlled list of applicable legislation, decrees, resolutions, regulations, codes, authority requirements and project obligations, with source, applicability, owner, evidence and review status.'),
      _DetailItem(title: 'Compliance Matrix', detail: 'A working matrix that converts each applicable obligation into a measurable project action, responsible person, required evidence, verification method and status.'),
      _DetailItem(title: 'Permit / Approval Control', detail: 'A structured process for identifying, obtaining, displaying, monitoring and closing permits, NOCs, authority approvals, certificates and inspection requirements before affected work.'),
      _DetailItem(title: 'Regulatory Change Management', detail: 'A process for detecting changes to applicable requirements, assessing their project impact, updating documents and communicating the change to affected personnel.'),
    ],
    items: [
      _DetailItem(title: 'Legal & Regulatory Register', detail: 'Records the requirement, issuing authority, reference, applicability, effective status, responsible owner, evidence and review date.'),
      _DetailItem(title: 'Compliance Matrix', detail: 'Links obligations to controls, documents, responsible persons, verification and close-out status.'),
      _DetailItem(title: 'Permit Register', detail: 'Tracks required permits, NOCs, approvals, issue dates, expiry dates, conditions and close-out.'),
      _DetailItem(title: 'Statutory Certificates', detail: 'Controlled evidence for applicable inspection, examination, testing, certification and authorization requirements.'),
      _DetailItem(title: 'Authority Correspondence', detail: 'Controlled records of submissions, comments, approvals, inspection observations and responses.'),
      _DetailItem(title: 'Audit Evidence', detail: 'Objective evidence demonstrating implementation, verification and corrective-action closure.'),
    ],
    sections: {
      '1. Purpose & Scope': [
        _DetailItem(title: 'Purpose', detail: 'Ensure the project can identify, understand, implement and demonstrate compliance with requirements applicable to its Dubai construction activities.'),
        _DetailItem(title: 'Scope', detail: 'Cover project planning, design interfaces, construction, temporary works, plant and equipment, workforce arrangements, environmental interfaces, emergency preparedness, permits, inspections, contractors and project close-out where applicable.'),
        _DetailItem(title: 'Applicability', detail: 'Only requirements applicable to the actual project, activity, location, equipment and contractual scope should be treated as project obligations. Applicability should be documented rather than assumed.'),
      ],
      '2. Legal & Regulatory Register — How to Build It': [
        _DetailItem(title: 'Step 1 — Identify sources', detail: 'Identify applicable UAE federal requirements, Dubai requirements, authority requirements, project approval conditions, contractual HSE requirements and other mandatory obligations relevant to the scope.'),
        _DetailItem(title: 'Step 2 — Confirm applicability', detail: 'For every reference, record why it applies, which activity or project area it affects and who owns implementation.'),
        _DetailItem(title: 'Step 3 — Verify current status', detail: 'Check the official source for current title, revision, effective date, amendments or replacement. Do not rely on an uncontrolled old copy.'),
        _DetailItem(title: 'Step 4 — Define evidence', detail: 'Specify what will demonstrate compliance: permit, certificate, inspection record, training record, procedure, drawing approval, photograph, audit record or other objective evidence.'),
        _DetailItem(title: 'Step 5 — Review', detail: 'Set a review trigger and review the register whenever requirements, project scope, construction method or authority conditions change.'),
      ],
      '3. Compliance Matrix — Practical Structure': [
        _DetailItem(title: 'Obligation', detail: 'State the requirement in clear operational language without changing its meaning.'),
        _DetailItem(title: 'Applicability', detail: 'Identify the project area, activity, equipment, workforce or contractor to which the obligation applies.'),
        _DetailItem(title: 'Control', detail: 'State the procedure, engineering control, permit, inspection, training or other measure used to implement the obligation.'),
        _DetailItem(title: 'Responsible Person', detail: 'Assign a named role or accountable person rather than leaving responsibility as a general department action.'),
        _DetailItem(title: 'Evidence', detail: 'Define the record that will prove implementation and the location where it is controlled.'),
        _DetailItem(title: 'Verification', detail: 'Specify inspection, audit, document review, field observation or other method used to confirm implementation.'),
        _DetailItem(title: 'Status', detail: 'Use a controlled status such as Open, In Progress, Compliant, Non-compliant, Pending Authority Action or Closed according to the project procedure.'),
      ],
      '4. Permits, NOCs & Authority Approvals': [
        _DetailItem(title: 'Pre-Work Check', detail: 'Before work starts, confirm all permits and approvals required for the actual activity and location have been obtained and any conditions have been incorporated into the work method.'),
        _DetailItem(title: 'Permit Conditions', detail: 'Permit conditions are controls, not paperwork. Supervisors should verify that required isolations, barriers, access restrictions, monitoring and competent-person requirements are physically implemented.'),
        _DetailItem(title: 'Display & Availability', detail: 'Where the applicable authority or project process requires a permit or approval to be displayed or available at site, maintain a current controlled copy accessible to the responsible team.'),
        _DetailItem(title: 'Expiry / Renewal', detail: 'Track expiry and renewal dates and do not continue work under an expired approval where a valid current approval is required.'),
        _DetailItem(title: 'Close-Out', detail: 'Close permits and authority actions in accordance with the project process and retain evidence of completion.'),
      ],
      '5. Construction HSE Documentation': [
        _DetailItem(title: 'Project HSE Plan', detail: 'The HSE plan should translate applicable requirements into project responsibilities, procedures, programmes, emergency arrangements, inspections, audits and reporting.'),
        _DetailItem(title: 'Risk Assessments & RAMS', detail: 'Applicable legal and authority requirements should be reflected in task risk assessments, RAMS and critical-control verification.'),
        _DetailItem(title: 'Permit-to-Work', detail: 'Where PTW applies, permit requirements should be linked to the task risk, isolations, competent persons and field verification.'),
        _DetailItem(title: 'Inspection & Test Records', detail: 'Maintain required inspection, testing and certification records for applicable plant, equipment and safety systems.'),
        _DetailItem(title: 'Training & Competency', detail: 'Maintain evidence of required training, competency, authorization and certification for safety-critical activities.'),
      ],
      '6. Contractor & Subcontractor Compliance': [
        _DetailItem(title: 'Prequalification', detail: 'Evaluate contractor HSE capability and applicable compliance evidence before appointment or mobilization according to project requirements.'),
        _DetailItem(title: 'Mobilization', detail: 'Verify that required documents, competent personnel, equipment certificates, procedures, emergency arrangements and project inductions are in place before work begins.'),
        _DetailItem(title: 'Ongoing Monitoring', detail: 'Monitor contractor compliance through inspections, audits, observations, document reviews and performance meetings.'),
        _DetailItem(title: 'Corrective Action', detail: 'Track contractor findings to verified closure. Repeated or significant non-compliance should be escalated through the project governance process.'),
      ],
      '7. Inspection, Audit & Regulatory Readiness': [
        _DetailItem(title: 'Routine Inspection', detail: 'Verify legal and authority controls at the workface, including permits, barriers, equipment certification, competency and required records.'),
        _DetailItem(title: 'Internal Audit', detail: 'Audit against identified compliance obligations and objective evidence rather than only checking whether documents exist.'),
        _DetailItem(title: 'Authority Inspection Readiness', detail: 'Maintain current approvals, permits, certificates, registers, drawings, records and responsible contacts so the project can demonstrate compliance when inspected.'),
        _DetailItem(title: 'Finding Management', detail: 'Record the requirement, evidence of non-compliance, immediate control, root or contributing cause where appropriate, corrective action, owner, due date and verification.'),
      ],
      '8. Non-Compliance & Corrective Action': [
        _DetailItem(title: 'Immediate Control', detail: 'Protect people and the environment first. Stop, isolate, barricade or otherwise control the affected exposure where required.'),
        _DetailItem(title: 'Assess Significance', detail: 'Determine the seriousness and scope of the gap using the project procedure and applicable requirement.'),
        _DetailItem(title: 'Corrective Action', detail: 'Define a specific action that addresses the actual compliance gap and assign an accountable owner and due date.'),
        _DetailItem(title: 'Effectiveness Check', detail: 'Closure should include verification that the required control is implemented and effective, not simply that an action was marked complete.'),
        _DetailItem(title: 'Trend Review', detail: 'Analyse repeated findings to identify systemic weaknesses in planning, supervision, competency, contractor control or document management.'),
      ],
      '9. Regulatory Change Management': [
        _DetailItem(title: 'Change Detection', detail: 'Monitor official authority publications and project communications for amendments, new requirements, revised guides, resolutions and changed approval conditions.'),
        _DetailItem(title: 'Impact Assessment', detail: 'Assess which activities, documents, permits, training arrangements, equipment controls and contractor requirements are affected.'),
        _DetailItem(title: 'Document Update', detail: 'Update the legal register, compliance matrix, HSE plan, procedures, RAMS, checklists and other affected controlled documents.'),
        _DetailItem(title: 'Communication', detail: 'Brief affected managers, supervisors, contractors and workers where the change alters work controls or responsibilities.'),
        _DetailItem(title: 'Implementation Verification', detail: 'Confirm the changed requirement is actually implemented in the field and retain evidence of the review and action taken.'),
      ],
      '10. Records & Evidence': [
        _DetailItem(title: 'Objective Evidence', detail: 'Use traceable records that demonstrate what was required, what was implemented, who verified it and when.'),
        _DetailItem(title: 'Document Control', detail: 'Maintain revision, approval, access and retention controls so current requirements are distinguishable from obsolete copies.'),
        _DetailItem(title: 'Expiry Tracking', detail: 'Monitor certificates, permits, training, authorizations and inspections that have defined validity periods.'),
        _DetailItem(title: 'Traceability', detail: 'Evidence should be traceable to the project, location, activity, equipment or person to which the requirement applies.'),
      ],
      '11. Roles & Responsibilities': [
        _DetailItem(title: 'Project Management', detail: 'Provide resources, authority and accountability for compliance and ensure significant gaps receive timely management attention.'),
        _DetailItem(title: 'HSE Management', detail: 'Coordinate identification of applicable HSE obligations, maintain or oversee the compliance system, monitor performance and report significant gaps.'),
        _DetailItem(title: 'Construction Management', detail: 'Integrate compliance requirements into work planning and ensure approved methods and controls are implemented at the workface.'),
        _DetailItem(title: 'Supervisors', detail: 'Verify permits, controls, competent personnel and site conditions before and during work and stop or escalate where critical controls are missing.'),
        _DetailItem(title: 'Document Control', detail: 'Maintain controlled requirements and evidence and prevent obsolete or uncontrolled references from becoming the basis for site decisions.'),
        _DetailItem(title: 'Contractors', detail: 'Meet applicable legal, authority and project requirements and provide evidence for verification.'),
        _DetailItem(title: 'Workers', detail: 'Follow approved controls and report unsafe conditions, permit deviations or suspected non-compliance.'),
      ],
      '12. Stop-Work / Escalation Conditions': [
        _DetailItem(title: 'Required Approval Missing', detail: 'Do not proceed where a mandatory permit, approval, NOC, certificate or other required authorization has not been obtained.'),
        _DetailItem(title: 'Critical Control Missing', detail: 'Stop or control the affected work when a critical legal, authority or project control is absent or ineffective.'),
        _DetailItem(title: 'Expired Requirement', detail: 'Do not rely on an expired permit, certificate, authorization or inspection where a valid current requirement applies.'),
        _DetailItem(title: 'Uncontrolled Change', detail: 'Pause and reassess when changed project conditions or regulatory requirements make the approved arrangement unreliable.'),
        _DetailItem(title: 'Authority Direction', detail: 'Follow applicable authority directions and escalate through project management where clarification or further action is required.'),
      ],
      '13. Practical Dubai Construction Example': [
        _DetailItem(title: 'Scenario', detail: 'A contractor is preparing a high-risk construction activity. The project compliance matrix identifies an approval condition, a task risk assessment, a competent-person requirement, equipment certification and inspection evidence as applicable controls.'),
        _DetailItem(title: 'Before Work', detail: 'The supervisor verifies the approved method, current permit/approval status, competent personnel, equipment records, exclusion arrangements and emergency controls before exposure begins.'),
        _DetailItem(title: 'During Work', detail: 'HSE and supervision verify that the field arrangement continues to match the approved controls and that no changed condition invalidates the compliance basis.'),
        _DetailItem(title: 'Finding', detail: 'If a required certificate or approval condition cannot be demonstrated, the affected work is controlled, the gap is recorded, responsibility is assigned and work resumes only after the applicable requirement is satisfied and verified.'),
      ],
      '14. Advanced Learning — Compliance Management System': [
        _DetailItem(title: 'Think in Obligations', detail: 'Advanced compliance management starts by converting legal language into clear operational obligations: what must be done, where, by whom, when, under what conditions and what evidence proves completion.'),
        _DetailItem(title: 'Build a Compliance Assurance Loop', detail: 'Use the cycle IDENTIFY → INTERPRET → IMPLEMENT → VERIFY → RECORD → REVIEW. The loop prevents compliance from becoming a static document exercise.'),
        _DetailItem(title: 'Link Compliance to Risk', detail: 'Where a legal or authority requirement controls a significant hazard, link the obligation to the risk assessment, critical control, RAMS, permit and inspection so the requirement is visible at the workface.'),
        _DetailItem(title: 'Measure Evidence Quality', detail: 'A strong compliance record demonstrates actual implementation. A signature alone may prove attendance or acknowledgement, but field evidence and verification may be needed to demonstrate that the control was actually in place.'),
        _DetailItem(title: 'Use Leading Indicators', detail: 'Track overdue compliance actions, expired certificates, permit deviations, repeat findings, late authority submissions and unverified corrective actions as early-warning indicators.'),
        _DetailItem(title: 'Manage Interfaces', detail: 'Many compliance failures occur at interfaces between client, consultant, main contractor, subcontractor, designer, plant supplier and authority. Define handover points and evidence ownership explicitly.'),
        _DetailItem(title: 'Escalate Uncertainty', detail: 'When the meaning or applicability of an official requirement is uncertain, obtain competent interpretation and confirm the controlling source rather than guessing or relying on an informal copy.'),
      ],
      '15. Key Learning Points': [
        _DetailItem(title: 'Know the requirement', detail: 'A project cannot demonstrate compliance with a requirement it has not identified and understood.'),
        _DetailItem(title: 'Make it operational', detail: 'Convert requirements into practical controls, responsibilities, permits, procedures and verification points.'),
        _DetailItem(title: 'Keep evidence', detail: 'Compliance must be demonstrable through current, traceable and objective evidence.'),
        _DetailItem(title: 'Verify in the field', detail: 'Paperwork and actual site conditions must agree.'),
        _DetailItem(title: 'Review continuously', detail: 'Legal compliance is a live management process affected by regulatory, project and site changes.'),
      ],
      '16. Reference Sources & Caution': [
        _DetailItem(title: 'Dubai Decree No. (19) of 2025', detail: 'A Dubai construction safety legal reference identified for this topic. Confirm the current official publication, scope, effective status and any amendments before applying it to a project decision.'),
        _DetailItem(title: 'Administrative Resolution No. (112) of 2026', detail: 'A Dubai Municipality administrative reference associated with approval of the Safety Guide for Construction Works in the Emirate of Dubai. Confirm the official current text and applicability.'),
        _DetailItem(title: 'Dubai Municipality Requirements', detail: 'Use current official Dubai Municipality technical guidelines, approvals, permits and requirements applicable to the project.'),
        _DetailItem(title: 'Project Requirements', detail: 'Project contracts, specifications, approved drawings, authority conditions and approved HSE documents may impose additional requirements.'),
        _DetailItem(title: 'Important Note', detail: 'This in-app reference is an HSE learning and field-reference aid. It does not replace current official legislation, authority instructions, project contractual requirements or competent legal advice.'),
      ],
    },
  ),
