...
List<_DubaiSection> _sectionsFor(ReferenceTopic topic, _TopicDetail d) {
  ...
  final details = <_DubaiSection>[
    ...
    _DubaiSection(title: titles[8], summary: 'What workers need to understand and do before and during the task.', detail: 'Workers should understand the hazards, required controls, limits of the equipment or method and the conditions that require them to stop and inform supervision.', bullets: [...d.hazards.take(3), ...d.controls.take(3)].toList()),
...
final Map<String, _TopicDetail> _details = {
